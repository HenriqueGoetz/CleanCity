...
public class MapaGoogle extends Parent {
    ...
    private void initMap()
    {
        ...
        //webEngine.load(getClass().getResource("../../../resources/html/mapa.html").toExternalForm());
        ...
        webEngine.getLoadWorker().stateProperty().addListener(new ChangeListener<Worker.State>()
        {
                                ...
                                final Worker.State newState)
            {
                if (newState == Worker.State.SUCCEEDED)
                {
                    ...
                    doc.setMember("app", MapaGoogle.this);
                }
            }
        });
    }
    ...
    public void setOnMapLatLngChanged(EventHandler<EventoDoMapa> eventHandler) {
        onMapLatLngChanged = eventHandler;
    }

    public void handle(double lat, double lng) {
        if(onMapLatLngChanged != null) {
            EventoDoMapa event = new EventoDoMapa(this, lat, lng);
    ...
    private EventHandler<EventoDoMapa> onMapLatLngChanged;
